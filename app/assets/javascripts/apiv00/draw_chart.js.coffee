#DynamicChart = (chart_area_test) ->
#  seq_num = $("#last_seq").text();
#  url = "/apiv00/front/test_data?seq=" + seq_num
#  data = []
#  series_data = chart_area_test.series[0]
#  $.ajax
#    type: 'GET'
#    url: url
#    data: data
...
#
#$ ->
#  chart_area_test = new Highcharts.Chart
...
#
#  data_list = chart_area_test.series[0]
#  data_list.addPoint(3)
#
##  DynamicChart(chart_area_test)
#
#  setInterval(DynamicChart, 5000, chart_area_test);
#    
